...
def create_order(db: Session, data, client: User) -> Order:
    ...
    order = Order(
        ...
        receiver_type=getattr(data, "receiver_type", None),
        receiver_last_name=getattr(data, "receiver_last_name", None),
        receiver_email=getattr(data, "receiver_email", None),
        receiver_account_type=getattr(data, "receiver_account_type", None),
        receiver_key=getattr(data, "receiver_key", None),
