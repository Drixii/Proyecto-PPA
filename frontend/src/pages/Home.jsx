      ...
      <style>{`
        ...
        *{box-sizing:border-box;}
        ...
        @media(max-width:768px){
          ...
          #hero-content>div{flex-direction:column;align-items:center;padding:78px 16px 100px;gap:14px!important;}
        ...
        @media(max-width:480px){
          ...
          #hero-content>div{padding:72px 12px 100px!important;gap:10px!important;}
