...
const CSS_PASOS = `
  ...
  .seccion-clara .paso-demo{background:#f5f9ff;border-color:rgba(11,28,63,.13);box-shadow:0 6px 20px rgba(11,28,63,.07);}
  ...
  .seccion-clara .paso-insignia{box-shadow:0 8px 22px rgba(56,189,248,.35),0 0 0 3px #f5f9ff;}
  .seccion-clara .paso-demo.hecho .paso-insignia,.seccion-clara .paso-demo.final .paso-insignia{box-shadow:0 8px 22px rgba(74,222,128,.35),0 0 0 3px #f5f9ff;}
