...
const STATUS_TIMELINE = {
  ...
  retenido: { label: 'Retención/Verificación', desc: 'Tu pago se recibió. Por el monto, estamos verificando el envío antes de entregarlo.' },
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <CampoSelector
                    ...
                    opciones={(data?.documentos || []).map(d => ({ valor: d.codigo, texto: d.nombre }))}
                    className="w-full rounded-xl px-3 py-2.5 text-sm"
                    style={{background:'rgba(6,13,40,.8)', border:'1px solid rgba(255,255,255,.1)', color:'#eaf2ff'}} />
                </div>
                <div>
