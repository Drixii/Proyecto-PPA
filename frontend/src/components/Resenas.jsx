...
export default function Resenas() {
  ...
  return (
    <section className="section-pad car seccion-clara" ref={zona}>
      <style>{`
        .car{position:relative;z-index:2;overflow:hidden;background:linear-gradient(180deg,#eef3fb,#f6f9fe);}
        ...
        .car-card{position:absolute;left:50%;top:50%;width:min(560px,86vw);box-sizing:border-box;margin:0;
          ...
          background:#fff;
          border:1px solid rgba(11,28,63,.1);box-shadow:0 26px 60px rgba(11,28,63,.12);
        ...
        .car-flecha{width:48px;height:48px;border-radius:50%;display:grid;place-items:center;cursor:pointer;color:#0b1c3f;
          background:#fff;border:1px solid rgba(11,28,63,.12);box-shadow:0 6px 18px rgba(11,28,63,.1);
